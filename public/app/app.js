...
function recopilarInfo(form){
	  var data =  $(form).serializeArray().reduce(function(obj, item) {
	  	...
	  	if(data.title && /*data.urlinfo *//* && data.urlfilmafinity && data.urlimage && data.description && */data.nameserver/* && data.urlvideo*/)  {
	  		return data
	  	}
  console.log('no estan todos');
